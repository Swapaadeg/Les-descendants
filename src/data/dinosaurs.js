...
export const arkDinosaurs = [
  ...
  { name: 'Dire Wolf', types: [1] },
  { name: 'Dire Bear', types: [1] },
  ...
  { name: 'Raptor', types: [1] },
  { name: 'Rex', types: [1] },
  { name: 'Sabertooth', types: [1] },
  { name: 'Spinosaur', types: [1, 3] },
  { name: 'Terror Bird', types: [1] },
  { name: 'Therizinosaur', types: [2] },
  ...
  { name: 'Woolly Rhino', types: [2] },
  { name: 'Ovis', types: [2] },
  { name: 'Roll Rat', types: [2] },
  ...
  { name: 'Scout', types: [2, 4] },
  { name: 'Sinomacrops', types: [1, 4, 5] },
  { name: 'Snow Owl', types: [1, 4] },
  ...
  // ===== AQUATIQUES =====
  { name: 'Ammonite', types: [2, 3] },
  { name: 'Anglerfish', types: [1, 3] },
  ...
  { name: 'Featherlight', types: [2, 5] },
  { name: 'Glowtail', types: [2, 5] },
  { name: 'Jerboa', types: [2, 5] },
  { name: 'Mesopithecus', types: [2, 5] },
  { name: 'Noglin', types: [1, 5] },
  { name: 'Otter', types: [1, 5] },
