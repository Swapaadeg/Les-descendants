-- ===========================
-- ARKI'FAMILY - DATABASE SCHEMA
-- Migration from single-tribe to multi-tribe system
-- ===========================

-- Désactiver les contraintes de clés étrangères pour la migration
...
-- ===========================
-- TABLE: dinosaurs (REFONTE)
-- ===========================
-- Renommer l'ancienne table si elle existe
DROP TABLE IF EXISTS dinosaurs_old;
RENAME TABLE dinosaurs TO dinosaurs_old;
...
-- ===========================
-- TABLE: sessions (optionnel si JWT)
-- ===========================
...
-- Note: La migration des données se fera via un script PHP séparé
-- pour pouvoir :
-- 1. Créer un utilisateur admin (toi)
-- 2. Créer la tribu "Les Descendants"
-- 3. Migrer tous les dinos existants vers cette tribu
-- 4. Te définir comme owner de la tribu
